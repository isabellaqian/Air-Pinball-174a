...
export class Assignment3 extends Scene {
  constructor() {
    ...
    this.TestObstacle = new Rectangular(
      this.shapes.cube,
      this.materials.test,
      1,
      vec3(0, 1, 0),
    ...
    this.left_floor = new Rectangular(
      this.shapes.cube,
      this.materials.test,
      vec3(-2, -8, 0),
      1,
    ...
    this.right_floor = new Rectangular(
      this.shapes.cube,
      this.materials.test,
      vec3(2, -2, 0),
      1,
    ...
    this.obstacles = [this.left_floor];
  }
  ...
  display(context, program_state) {
    ...
    this.TestObstacle.render(context, program_state, model_transform);
